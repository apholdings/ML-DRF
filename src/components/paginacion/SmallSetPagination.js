            ...
            {currentPage !== 1 ? (
                <div className="-mt-px w-0 flex-1 flex">
                    <div
                        ...
                        className="cursor-pointer border-t-2 border-transparent pt-4 pr-1 inline-flex items-center text-sm font-gilroy-medium text-gray-500 hover:text-gray-700 hover:border-gray-300"
                    >
                        <ArrowNarrowLeftIcon
                ...
                <div className="-mt-px w-0 flex-1 flex">
                    <div className="cursor-pointer border-t-2 border-transparent pt-4 pr-1 inline-flex items-center text-sm font-gilroy-medium text-gray-500 hover:text-gray-700 hover:border-gray-300"></div>
                </div>
            )}
            ...
            {currentPage === numbers.length ? (
                ...
                <div className="-mt-px w-0 flex-1 flex justify-end">
                    <button
                        ...
                        className="border-t-2 border-transparent pt-4 pl-1 inline-flex items-center text-sm font-gilroy-medium text-gray-500 hover:text-gray-700 hover:border-gray-300"
                    >
                        Next
